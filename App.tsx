...
import { ChatMessage, Language } from './src/types';
import { LANGUAGES, THEME } from './src/constants';
import { useRecorder } from './src/hooks/useAudio';
import { transcribeAudio, translateText } from './src/services/openai';
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.header}>
        <Text style={styles.headerTitle}>FutureTalk</Text>
      ...
      >
        {history.length === 0 && (
          <View style={styles.emptyState}>
            ...
            <Text style={styles.emptySub}>Select languages and tap to speak</Text>
          </View>
        )}
